...
fig, ax = plt.subplots()
plt.plot(train_losses, label="Train Loss", linestyle='-', color='#FF6F61', linewidth=2, markersize=5, )
plt.plot(val_losses, label="Validation Loss", linestyle='-', color="#690F0F", linewidth=2, markersize=5, )
