...
def make_predictions(race_data, track_data):
    ...
    for i in range(len(race_data)):
        ...
        results.append({"driver num":race_data[i]["driver_number"], "time":predicted_time})
        print("Predicted average lap time for driver number",race_data[i]["driver_number"],":", predicted_time)
...
make_predictions(race_data, track_data)